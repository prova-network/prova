/**
 * Cryptographic primitives for Prova SDK.
 * Uses Web Crypto API (browser + Node.js 18+).
 * Falls back to a pure-JS SHA-256 for environments without SubtleCrypto.
 */

// ── SHA-256 (sync, pure-JS for deterministic use in WASM/tests) ──
...
export function sha256(data: Uint8Array): Uint8Array {
  ...
  const padLen = ((data.length + 9 + 63) & ~63); // next multiple of 64
